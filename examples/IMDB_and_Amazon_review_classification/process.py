...
def train(args, labeled, resume_from, ckpt_file):
    ...
    iterator, TEXT, LABEL, tabular_dataset = load_data(stage="train", args=args, indices=labeled)
...
def test(args, ckpt_file):
    ...
    iterator, TEXT, LABEL, tabular_dataset = load_data(stage="test", args=args, indices=None)
    ...
    model.load_state_dict(torch.load(os.path.join(args["EXPT_DIR"], ckpt_file + ".pth"))["model"])
...
def infer(args, unlabeled, ckpt_file):
    ...
    iterator, TEXT, LABEL, tabular_dataset = load_data(stage="infer", args=args, indices=unlabeled)
